...
#Dirichlet-Multinomial parameters (ln(theta)) controlling length and age comp weights
  -5   20      0.5     0     99       0       2       0        0         0         0       0        0       0  #  ln(EffN_mult)_fleet2_length (fixed to 1)
  -5   20      0.5    0     99       0       2       0        0         0         0       0        0       0  #  ln(EffN_mult)_fleet3_length
  -5   20      0.5     0     99       0       2       0        0         0         0       0        0       0  #  ln(EffN_mult)_fleet4_length (fixed to 1)
