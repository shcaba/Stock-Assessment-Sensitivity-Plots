...
1 #_Forecast recruitment:  0= spawn_recr; 1=value*spawn_recr_fxn; 2=value*VirginRecr; 3=recent mean from yr range above 
...
2003 # Rebuilder:  first year catch could have been set to zero (Ydecl)(-1 to set to 1999)
2006 # Rebuilder:  year for current age structure (Yinit) (-1 to set to endyear+1)
