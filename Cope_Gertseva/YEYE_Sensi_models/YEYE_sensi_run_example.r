...
SS_Sensi_plot(model.summaries=model.summaries,
              ...
              anno.x=c(3.5,7,9.5,12.5,17.5,24), # Vertical positioning of the sensitivity types labels
              anno.y=c(1.9,1.9,1.9,1.9,1.9,1.9), # Horizontal positioning of the sensitivity types labels
              anno.lab=c("Ageing Err","M","h","L-W;Mat.","Removals","Other") #Sensitivity types labels
)
